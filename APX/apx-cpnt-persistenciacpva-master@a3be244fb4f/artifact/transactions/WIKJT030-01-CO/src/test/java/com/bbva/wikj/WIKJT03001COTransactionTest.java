...
/**
 * Test for transaction WIKJT03001COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT03001COTest.xml" })
public class WIKJT03001COTransactionTest {

	@Autowired
	private WIKJT03001COTransaction transaction;
